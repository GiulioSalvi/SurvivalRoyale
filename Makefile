...
main: src/main.c bin/objects/ansi-c$(CV).o bin/objects/vector-c$(CV).o
	$(CC) $(CCFLAGS) src/main.c bin/objects/ansi-c$(CV).o bin/objects/vector-c$(CV).o -o bin/exec/project
